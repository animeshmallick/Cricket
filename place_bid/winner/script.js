...
function update_winner_slots(update_selected){
    ...
    fetchWrapper(`${window.location.protocol}//${window.location.hostname}/Cricket/internal/GetWinnerSlotDetails.php?series_id=${series_id}&match_id=${match_id}&session=${session}&room=${room}&amount=${amount}`)
