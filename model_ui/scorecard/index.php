<div id="scorecard-container" class="shadow-lg border border-gray-500 p-1 bg-gray-310 card-container">
    ...
    <div class="space-y-1">
        <div class="team-hover flex justify-between items-center text-sm rounded-md" id="team1_container" onclick="openScorecardPopup('team1', '<?= $_SESSION['customer_id']?>')">
        ...
        <div class="team-hover flex justify-between items-center text-sm rounded-md" id="team2_container" onclick="openScorecardPopup('team2', '<?= $_SESSION['customer_id']?>')">
